...
APP_ID: "int" = int(os.getenv("APP_ID", 12376796))
APP_HASH = os.getenv("APP_HASH", "84f3526d09b1c69d116fb0531c1d5065")
TOKEN = os.getenv("TOKEN", "5056032122:AAEDXhvILsiNKtswBwIJ7o5BEpghK2jsuFI")
